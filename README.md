...
HotelBookingApp is a modern web application designed to simplify the hotel reservation process for both customers and hotel managers.
The application is built using **Java and Spring Boot** for the backend and **Thymeleaf** for the frontend, following the **Model-View-Controller (MVC)** architecture.
